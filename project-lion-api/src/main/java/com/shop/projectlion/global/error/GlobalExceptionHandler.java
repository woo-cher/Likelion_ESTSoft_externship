...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMissingRequestHeaderException(MissingRequestHeaderException e) {
        ...
        ErrorCode wrapped = ErrorCode.NOT_EXISTS_AUTHORIZATION;
        HttpStatus httpStatus = HttpStatus.valueOf(wrapped.getStatus());
        ErrorResponse errorResponse = ErrorResponse.of(httpStatus, List.of(wrapped.getMessage()));
        return ResponseEntity.status(httpStatus).body(errorResponse);
    }
