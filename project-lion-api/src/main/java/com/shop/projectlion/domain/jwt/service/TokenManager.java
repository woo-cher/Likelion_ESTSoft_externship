...
public class TokenManager {
    ...
    public TokenDto createTokenDtoOnlyAccessToken(String email, Role role) {
        Date accessTokenExpireTime = createAccessTokenExpireTime();
        String accessToken = createAccessToken(email, role, accessTokenExpireTime);
    ...
    public boolean isTokenExpired(Date tokenExpiredTime) {
        return new Date().after(tokenExpiredTime);
    }

    public String getBearerTokenInAuthHeader(String tokenHeaderValue) {
        return tokenHeaderValue.replace(GrantType.BEARRER.getType(), "").trim();
    }
